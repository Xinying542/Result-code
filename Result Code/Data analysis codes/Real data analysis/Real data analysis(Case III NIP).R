#The results of the real data analysis in Case III under NIP.
...
RXJ=Datah$RXJ
TimX=Datah$TimX
NRvalue<-NewtonsX(funs,Datah,theta=c(1.2,0.12),R1)
EMvalue<-EM12(R1,0.12,1.2)
...
path <- file.path("E://progress result1119","case3realdataEstimateNIP.xls")
